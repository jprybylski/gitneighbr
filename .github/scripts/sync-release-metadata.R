...
#
# Ported from ../deckifyr's .github/scripts/sync-release-metadata.R (itself
# ported from ../quartifyr, which ported it from ../xpose.xtras) -- this file
# is package-agnostic (Package is read from DESCRIPTION, not hardcoded), so
# it carried over unmodified.
